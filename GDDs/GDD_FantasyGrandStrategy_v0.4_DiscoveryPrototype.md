...
**Version 0.4 — Discovery-First Prototype Pressure Added**
...
*Document status: Living draft — all v0.1 design questions resolved; discovery-first prototype thesis added.*
...
### 13.4 First Strategic Equipment Decision
...
### 13.6 Long-Term Pressure Direction
...
### 13.7 Updated v0.1 Build Scope

**Map:** Region-node graph, 5–8 regions, organic visual terrain. No visible hex grid.

**Factions:** One player faction, one local rival or raider actor, one distant Legacy Empire border presence. The rival/raider does not need full strategic AI; it only needs enough behavior to notice, contest, raid, spy on, or steal samples from the discovered ore site.
...
**Discovery:** Tier 1 immediate observation, Tier 2 practical testing, and one simple Tier 3 academy analysis. Field discovery appears as event notifications after equipment is used.

**Equipment fork:** The first scarce ore batch can be committed to weapons, armor, or research delay. Weapons and armor should produce different strategic postures.
...
**Threat/pressure:** Ore discovery triggers local interest. The player is pressured to claim, extract, move, study, and use the ore before another actor interferes.
...
### 13.8 Next Design Questions

The next unresolved prototype questions are:

1. What is the first strange ore's possible property set?
2. What are the weapon and armor outcomes for that material?
3. What exactly can the rival/raider actor do after discovering the ore site?
...
*Recommended next session: define the first material, its weapon/armor forks, and the ore-discovery pressure chain in playable detail.*
