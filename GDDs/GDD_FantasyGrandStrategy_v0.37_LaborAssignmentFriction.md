...
**Version 0.37 — Labor Assignment Friction and Continuity Added**
...
*Document status: Living draft — v0.1 prototype scope updated with population-rooted economy, manpower loss, supplies, starting asset model, and labor assignment friction.*
...
Killed people permanently reduce the population and workforce potential. Wounded people temporarily occupy the recovery pool and return only after enough time, safety, and supplies.
...
2. What exact action should create the first mobile squad when armory stockpiles start at zero: improvised militia, basic equipment project, or a sequence that supports both?
3. How should the combat-result UI display population consequences: killed, wounded, captured/missing, returned survivors, recovered equipment, and workforce impact?
...
*Recommended next session: define Hearthmere's exact starting population/economy numbers, first squad creation flow, casualty display, and one example Redglass Codex reveal sequence.*
