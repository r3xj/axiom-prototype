...
**Version 0.9 — Prototype Magical Properties Added**
...
### 13.6 First Strategic Equipment Decision
...
### 13.9 Raider Counterplay and Attention Model
...
### 13.10 Long-Term Pressure Direction
...
### 13.11 Updated v0.1 Build Scope
...
**Equipment fork:** The first scarce ore batch can be committed to weapons, armor, or research delay. Weapons and armor should produce different strategic postures because of the material's generated properties, elemental responses, and delayed magical behavior, not because of fixed hard-coded bonuses.
...
### 13.12 Next Design Questions

The next unresolved prototype questions are:

1. What exact weapon and armor outcomes can be derived from the v0.1 physical and magical property set?
2. How does the player learn a delayed magical property through academy analysis, field use, or both?
...
*Recommended next session: define the first weapon and armor outputs and how physical sliders, elemental responses, and delayed magical properties affect them.*
