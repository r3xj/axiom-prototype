...
**Version 0.32 — Abstract Combat Context Resolvers Added**
...
### 13.23 Prototype Squad Manpower and Equipment Model
...
### 13.24 Prototype Scenario End Conditions and Victory Paths
...
### 13.25 Prototype Resource and Starting Asset Model
...
### 13.26 Updated v0.1 Build Scope
...
### 13.27 Next Design Questions

The next unresolved prototype questions are:

1. What exact starting values should v0.1 use for labor, coin/liquid value, supply production/stockpiles, basic weapons, basic armor/shields, Hearthmere Militia manpower, and prospect leads?
...
6. What minimum combat-result UI is needed to show outcome, losses, cargo status, equipment performance, supply impact, and field discoveries?

*Recommended next session: define the concrete combat result UI, then assign rough starting values to the v0.1 resource/asset model and example Redglass Codex reveal sequence.*
