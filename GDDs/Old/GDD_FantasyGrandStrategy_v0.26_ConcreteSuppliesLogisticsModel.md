...
**Version 0.26 — Concrete Supplies Logistics Model Added**
...
| **Supplies / Rations** | Concrete physical goods consumed by mines, remote squads, caravans, and possibly settlements. Supplies exist in local stockpiles and must be shipped where needed. |
...
- A starting **Supplies** stockpile at Hearthmere, enough to support early mining and squad movement but not enough to ignore supply routes forever.
...
- **Squads consume supplies away from Hearthmere.** A squad guarding a remote mine, escorting caravans, scouting Ashen Pass, or attacking Blackbanner Camp draws from carried supplies or a nearby supplied site.
...
The v0.1 implementation does not need a full food economy, spoilage model, or civilian consumption simulation. It only needs to prove that supplies are physical goods that support remote activity and create meaningful logistical vulnerability.

Minimum v0.1 supply rules:

1. Hearthmere has a supply stockpile.
2. The Redglass mine consumes supplies while active.
3. Remote squads consume supplies slowly while assigned away from Hearthmere.
4. The player can create a supply shipment route from Hearthmere to the mine or a guard post.
5. If a mine or remote squad lacks supplies, it becomes less effective or stops functioning.
6. Raiders can choose supply shipments as targets when those shipments are exposed.
...
**Starting assets:** The player starts with Hearthmere, a small population/labor pool, limited coin/liquid value, a starting Hearthmere supply stockpile, modest basic weapons and armor/shield stockpiles, one basic militia/guard squad, survey capacity, basic Forge and Academy access, several visible prospect leads, and basic knowledge of nearby regions. Supplies are included as concrete local goods used to support the mine and remote squads.
...
1. What exact starting values should v0.1 use for labor, coin/liquid value, supplies, basic weapons, basic armor/shields, squads, and prospect leads?
