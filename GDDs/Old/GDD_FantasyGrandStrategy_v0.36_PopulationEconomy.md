...
**Version 0.36 — Population, Manpower, and Supply Economy Model Added**
...
*Document status: Living draft — v0.1 prototype scope updated with population-rooted economy, manpower loss, supplies, and starting asset model.*
