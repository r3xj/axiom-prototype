...
**Version 0.53 — Phase 2 Raider Integration Plan Added**
...
### 13.36 Updated v0.1 Build Scope
...
4. Which Phase 1 playtest failure modes appear first: progress-bar soup, fake logistics, global inventory confusion, Codex irrelevance, or no future pull?
5. What starting tuning values should be used later for improvised militia strength, proper watch squad strength, supply use, and equipment coverage once Phase 3/4 adds raiders?
6. Which full v0.1 victory paths should be required after raiders are added versus treated as optional stretch goals?
7. Which Phase 1 objects should be represented in UI first: settlement/population, prospects, projects, stockpiles, shipments, or Codex?

*Recommended next session: define the no-raider completion condition, then set Hearthmere's starting population/economy numbers for the first implementation slice. After Phase 1 passes, return to the Phase 2 raider integration plan and implement caravan ambush first.*
