...
**Version 0.7 — Systems-Driven Material Model Added**
...
- **Heat behavior** — heat resistance, heat retention, flammability, self-cooling, melting point
- **Corrosion / decay resistance** — durability against weather, rot, poison, acid, or time
- **Resonance** — tendency to ring, vibrate, amplify sound, magic, fear, or ritual effects
- **Appeal** — cultural, aesthetic, morale, trade, prestige, fear, or religious value

Magical properties can be layered on as tags or conditional traits rather than sliders. Examples include fire resistance, cold retention, lightning attraction, levitation, magic amplification, healing resonance, undead toxicity, divine attunement, void contamination, animal agitation, temporal stability, dream influence, ancestor resonance, or force rebound.
...
- Fire resistance as a tag may matter more for shields, armor, gates, and caravans than for swords.
...
### 13.5 First Strategic Equipment Decision
...
### 13.8 Raider Counterplay and Attention Model
...
### 13.9 Long-Term Pressure Direction
...
### 13.10 Updated v0.1 Build Scope

**Map:** Region-node graph, 5–8 regions, organic visual terrain. No visible hex grid.
...
**Discovery:** Tier 1 immediate observation, Tier 2 practical testing, and one simple Tier 3 academy analysis. Field discovery appears as event notifications after equipment is used. The first material should be driven by hidden physical qualities and magical tags, with the player seeing qualitative descriptions rather than raw stats.

**Equipment fork:** The first scarce ore batch can be committed to weapons, armor, or research delay. Weapons and armor should produce different strategic postures because of the material's generated properties, not because of fixed hard-coded bonuses.
...
**The test:** One settlement, one strange ore deposit, one mine, one caravan route, one forge/workshop, one academy or research action, one equipment fork, and one local actor capable of contesting the ore chain. If the player feels curiosity, pressure, and adaptation from that scenario, the foundation works.

### 13.11 Next Design Questions

The next unresolved prototype questions are:

1. Which physical sliders and magical tags are required for the v0.1 material model, and which can wait?
2. What are the first weapon and armor outcomes that can be derived from those properties?
3. What exact warning signals and UI alerts tell the player the local attention state has changed?
4. What does the first map look like region by region?
5. What are the first five buttons the player clicks?
6. What ends the prototype scenario?

*Recommended next session: choose the minimum v0.1 property set and define how those properties produce weapon, armor, research, and field-discovery outcomes.*
