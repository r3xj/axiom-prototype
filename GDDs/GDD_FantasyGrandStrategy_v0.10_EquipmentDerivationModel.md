...
**Version 0.10 — Equipment Derivation Model Added**
...
### 13.7 Equipment Derivation Model
...
### 13.10 Raider Counterplay and Attention Model
...
### 13.11 Long-Term Pressure Direction
...
### 13.12 Updated v0.1 Build Scope
...
### 13.13 Next Design Questions

The next unresolved prototype questions are:

1. How does the player learn a delayed magical property through academy analysis, field use, or both?
2. What exact warning signals and UI alerts tell the player the local attention state has changed?
3. What does the first map look like region by region?
4. What are the first five buttons the player clicks?
5. What ends the prototype scenario?

*Recommended next session: define the discovery reveal path for delayed magical properties — what testing can predict, what academy analysis can identify, and what only field use can prove.*
