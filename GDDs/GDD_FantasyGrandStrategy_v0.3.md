...
**Version 0.3 — Tactical Battle System Added**
...
*Document status: Living draft — all v0.1 design questions resolved.*

---

## Next Step: Prototype Scope Definition

All seven open design questions are resolved. The v0.1 prototype has a clear, buildable scope:

**Map:** Region-node graph, 5–8 regions, organic visual terrain. No visible hex grid.

**Factions:** One player faction, one rival AI faction, one Legacy Empire on the border.
...
**Discovery:** Tier 1 (immediate observation) and Tier 2 (basic testing) functional. Tier 3 (formal analysis) represented by one Academy building. Field discovery (Tier 4) surfaced as event notifications.

**Staffing:** Settlement labor pools with broad priority sliders. One specialist slot per major facility.

**Coalition AI:** Lightweight — Cause, Convener, Members, Cohesion score, one contribution type per member.

**Real-time:** Continuous with pause and speed controls. Crisis events auto-slow to minimum speed.

**The test:** One settlement, one mine, one caravan route, one workshop, one threat capable of disrupting the route. If that scenario creates interesting decisions, the foundation works.

*Recommended next session: Build the prototype map and logistics loop.*
